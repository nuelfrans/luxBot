...
public abstract class PermissionUtils {
    ...
    public static void requestPermission(AppCompatActivity activity) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.ACCESS_FINE_LOCATION)) {
            ...
            PermissionUtils.RationaleDialog.newInstance(GPSFunction.LOCATION_PERMISSION_REQUEST_CODE, true)
                    .show(activity.getSupportFragmentManager(), "dialog");
        } else {
            // Location permission has not been granted yet, request it.
            ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, GPSFunction.LOCATION_PERMISSION_REQUEST_CODE);
